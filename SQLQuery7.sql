/****** Object:  Database [RestaurantTableBooking]    Script Date: 7/24/2024 5:38:56 PM ******/
CREATE DATABASE [RestaurantTableBooking]  (EDITION = 'Standard', SERVICE_OBJECTIVE = 'S0', MAXSIZE = 250 GB) WITH CATALOG_COLLATION = SQL_Latin1_General_CP1_CI_AS;
GO

ALTER DATABASE [RestaurantTableBooking] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET ARITHABORT OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [RestaurantTableBooking] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [RestaurantTableBooking] SET ALLOW_SNAPSHOT_ISOLATION ON 
GO

ALTER DATABASE [RestaurantTableBooking] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [RestaurantTableBooking] SET READ_COMMITTED_SNAPSHOT ON 
GO

ALTER DATABASE [RestaurantTableBooking] SET  MULTI_USER 
GO

ALTER DATABASE [RestaurantTableBooking] SET ENCRYPTION ON
GO

ALTER DATABASE [RestaurantTableBooking] SET QUERY_STORE = ON
GO

ALTER DATABASE [RestaurantTableBooking] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 100, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO)
GO
...
ALTER DATABASE [RestaurantTableBooking] SET  READ_WRITE 
GO
